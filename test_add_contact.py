...
class test_add_contact(unittest.TestCase):
    ...
    def fill_user_form(self, wd, contact, droplist, droplist2):
        # fill user form
        ...
        if not wd.find_element_by_xpath("//div[@id='content']/form/select[2]//option[8]").is_selected():
            wd.find_element_by_xpath(droplist2).click()
    ...
    def test_test_add_contact(self):
        ...
        self.fill_user_form(wd, Contact(firstname="Alex", middlename="a", lastname="Kriv", nickname="sd", title="fdf",
    ...
    def test_test_add_empty_contact(self):
        ...
        self.login(wd)
        self.init_new_user(wd)
        self.fill_user_form(wd, Contact(firstname="", middlename="", lastname="", nickname="", title="", company="",
