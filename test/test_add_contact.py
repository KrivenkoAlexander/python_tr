...
test_data=[Contact(firstname=random_str("firstname",10), middlename=random_str("middlename",10), lastname=random_str("lastname",10), nickname='nickname', title='title',
                                        ...
                                        droplist3="//div[@id='content']/form/select[3]//option[3]",droplist4="//div[@id='content']/form/select[4]//option[8]") for i in range(3)]
